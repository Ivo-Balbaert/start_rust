...
// words:
	for word in str1.words() {
        print!("{} / ", word);
    }
    println!("");

// changing a String:
	let str5: String = str1.replace("Level", "Floor");
	println!("{}", str5); // Ɵ Level 1 is finished - Rise up to Level 2

// string parameters:
	println!("Length of Merlin: {}", how_long(magician1));
	println!("Length of str1: {}", how_long(str1.as_slice()));
}
